      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('tentang.update', $abouts->id)}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                @method('PUT')
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                    <input type="text" name="title_about" id="title_about" required="required" class="form-control" value="{{$abouts->title_about}}">
                  </div>
                </div>
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                    <textarea class="form-control" rows="3"  name="description_about" id="description_about" required>{{$abouts->description_about}}</textarea>
                    <script>
